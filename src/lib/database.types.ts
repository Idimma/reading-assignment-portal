  ...
  public: {
    Tables: {
      assignment_records: {
        ...
        Relationships: [
          {
            foreignKeyName: "assignment_records_assignment_id_fkey"
          ...
          {
            foreignKeyName: "assignment_records_student_id_fkey"
            columns: ["student_id"]
            isOneToOne: false
      ...
      reading_sessions: {
        ...
        Relationships: [
          {
            foreignKeyName: "reading_sessions_record_id_fkey"
            columns: ["record_id"]
            isOneToOne: false
    ...
    Functions: {
      create_assignment: {
        Args: { p_book_id: string; p_class_id: string; p_due_date: string }
        Returns: string
      }
